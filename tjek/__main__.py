...
from tjek import find_changed_files, __version__


app = typer.Typer(
    name="tjek",
    add_completion=False,
    help="Tjek helps you understand changed git files.",
)
...
@app.command()
def ifchanged(
    files: List[Path] = typer.Argument(..., help="The file to count the words in."),
    command: str = typer.Argument(
        ..., help="Command to run if need changes are detected."
    ),
